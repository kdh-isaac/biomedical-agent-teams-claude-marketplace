# Claude Code Runtime Capability Matrix

Use this reference during runtime capability preflight. It maps common upstream
workflow wording to actual Claude Code surfaces.

| requested capability | acceptable Claude Code evidence | downgrade if unavailable |
|---|---|---|
...
available or used in the active Claude Code runtime.
